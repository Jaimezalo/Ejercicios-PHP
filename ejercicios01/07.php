...
<body>
	...
	<p class="rojo">Rojo (<?= $filaRoja ?>) </p>
	<p class="verde">Verde (<?= $filaVerde ?>) </p>
	<p class="azul">Azul (<?= $filaAzul ?>) </p>
	<p class="negro">Negro (<?= $filaNegra ?>) </p>
	<p class="amarillo">Amarillo (<?= $filaAmarilla ?>) </p>
	<p class="rosa">Rosa (<?= $filaRosa ?>) </p>
</body>
</html>